...
import tracker.AffectedModuleDetector.Companion.CHANGED_PROJECTS_ARG
import tracker.AffectedModuleDetector.Companion.DEPENDENT_PROJECTS_ARG
import tracker.AffectedModuleDetector.Companion.ENABLE_ARG
import java.io.File
    ...
    companion object {
        ...
        fun configure(gradle: Gradle, rootProject: Project) {
            ...
            val logger = ToStringLogger.createWithLifecycle(gradle) { log ->
                val distDir = rootProject.projectDir
                distDir.let {
            ...
            logger.info("setup: enabled: $enabled, inBuildServer: ")
